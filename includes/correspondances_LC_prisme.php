...
if(isset($arretsuivant1)){
    if($arretsuivant1 == 18){ ?>
        <div class="corresp0">
            ...
            <img src="correspondances/Ligne_21.png" alt="Ligne 21" class="imagecorresp"> 
            <img src="correspondances/Ligne_49.png" alt="Ligne 49" class="imagecorresp"> 
    ...
    <?php } elseif($arretsuivant1 == 12){ ?>
        <div class="corresp0">
        <img src="correspondances/Ligne_12.png" alt="Ligne 12" class="imagecorresp"> </div>
    <?php }elseif($arretsuivant1 == 11){ ?>
        <div class="corresp0">
    ...
    <?php }elseif($arretsuivant1 == 4){ ?>
        <div class="corresp0">
            <img src="correspondances/Ligne_D.png" alt="Ligne D" class="imagecorresp">
            <img src="correspondances/Ligne_C5.png" alt="Ligne C5" class="imagecorresp">
            <img src="correspondances/Ligne_15.png" alt="Ligne 15" class="imagecorresp">
        </div>
    <?php }elseif($arretsuivant1 == 2){ ?>
        <div class="corresp0">
            <img src="correspondances/Ligne_B.png" alt="Ligne B" class="imagecorresp">
        </div>
    <?php }elseif($arretsuivant1 == 1){ ?>
        <div class="corresp0">
            <img src="correspondances/Ligne_B.png" alt="Ligne B" class="imagecorresp">
            <img src="correspondances/Ligne_C5.png" alt="Ligne C5" class="imagecorresp">
