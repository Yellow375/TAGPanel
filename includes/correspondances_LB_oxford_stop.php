...
if(isset($arretsuivant1)){
    if($arretsuivant1 == 19 || $arretsuivant1 == 20){?>
    ...
    <?php } elseif($arretsuivant1 == 17){ ?>
        <div class="imagecorrespstop">
        <img src="correspondances/Ligne_A.png" alt="Ligne A" class="imagecorresp"> </div>
    ...
    <?php }elseif($arretsuivant1 == 11){ ?>
        <div class="imagecorrespstop">
            ...
            <img src="correspondances/Ligne_62.png" alt="Ligne 62" class="imagecorresp">
        </div>
